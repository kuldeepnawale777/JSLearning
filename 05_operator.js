...
var num2 = 2; var result = num1 + num2; // Addition 
...
console.log(`Multiplication is ${result}`);
 ...
 result = num1 / 3; console.log(` Division is ${result} `);
 ...
 var num3 = "10"; 
 var num4 = 10; 
 console.log(num3==num4); // 10==10 console.log(num3===num4)


var marks = 70;
var result=marks >=60 ? "Allow him to interview" : "don't allow";
...
var myNumber=7;
//even - divide by 2 and reminderis 0
console.log(result);
