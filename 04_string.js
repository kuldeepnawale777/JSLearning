...
console.log("chareter avaliable at index 3 is :",charAtIndex3);

console.log("Find the las t character");

var charAtLastIndex = greet.charAt(greetLength-1)

console.log("Last car is :",charAtLastIndex);


console.log("Find the index by characgter value");
...
//Find total extra speaces removed from the string.



var count = myName.length - myNameAfterTrim.length;

console.log("Find total extra speaces removed from the string.:",count);
...
var myFriendList = "Billgates, Stew Job, Elon Musk, Ratan Tata,Sundar Pivhai, Satya Nadella, Narayan Murti,Nandan Nilekani, Larry Pge, Surgey Brain, Tim Cook, ";

var splitTotalFriendList= myFriendList.split(",").length;
console.log("Total number of Friend List :",splitTotalFriendList);
